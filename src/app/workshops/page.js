  ...
  return (
    <div className="min-h-screen text-slate-100" style={{ background: "#05080f" }}>
      <div className="relative" style={{ zIndex: 1 }}>
        ...
        <section className="relative py-20 px-4 text-center border-b-[6px] border-[#3182ce] overflow-hidden mt-10">
          <div className="absolute inset-0 z-0" style={{ background: 'radial-gradient(ellipse at center, #111827 0%, #030712 100%)' }}></div>
          <div className="relative z-10">
            <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tighter bg-gradient-to-r from-[oklch(95%_0.10_200)] to-[oklch(71.5%_0.143_215.221)] bg-clip-text text-transparent italic tracking-tight">
              PAST WORKSHOPS
            </h1>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cards.map((card) => (
              <div key={card.id} className="group relative h-80 bg-[#1a1c20]/40 backdrop-blur-md border border-gray-800 hover:border-[#3182ce] overflow-hidden transition-all duration-300 rounded-sm">
                <div className="absolute inset-0 p-8 flex flex-col justify-center transition-opacity duration-300 group-hover:opacity-0">
                  ...
                  <h3 className="text-3xl font-extrabold bg-gradient-to-r from-[oklch(95%_0.10_200)] to-[oklch(71.5%_0.143_215.221)] bg-clip-text text-transparent italic leading-tight">{card.title}</h3>
                </div>
                <div className="absolute inset-0 p-8 bg-[#0a0a0b]/90 backdrop-blur-xl flex flex-col justify-center translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-[oklch(95%_0.10_200)] to-[oklch(71.5%_0.143_215.221)] bg-clip-text text-transparent italic mb-3">{card.title}</h3>
        ...
        <footer className="bg-[#050505] border-t border-gray-900 pt-16 pb-8 mt-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-10 max-w-2xl mx-auto">
              ACM Student Chapter at DTU is the technical society at the Department of Information Technology, DTU.
            </p>
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              exit={{ opacity: 0, y: 20 }}
              onClick={scrollToTop}
              className="fixed bottom-8 right-8 bg-white text-black p-4 rounded-full shadow-2xl z-50 flex items-center justify-center"
            >
